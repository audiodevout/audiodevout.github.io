      ...
      installations: [
        {
          ...
          fullDescription:
            "Rain Reminders is a meditative kinetic installation that reimagines the rain stick as a durational, healing sound object. At its center, a handmade 80 cm rain stick made with a PVC pipe, screws and filled with a mixture of mung beans and black rice, is rotated on its horizontal axis by a stepper motor, releasing a steady cascade of trickles that generate an unamplified texture reminiscent of rainfall.\nThe sculpture is built from coarse, industrial elements—steel square tubing, a 6x4 wood beam, exposed screws, and visible wiring. A coir mat rests beneath the frame.\nThe work emerged as a personal response to tinnitus, where the steady presence of this customised noise becomes a form of relief. In this context, the installation functions as a sonic prosthesis: a quiet companion producing persistent acoustic weather. Its sound is soft but continuous, mechanically repeated yet organic, an object that occupies the background while inviting careful listening.\nThis installation is not built for spectacle. It sits between ritual and mechanism, noise and stillness. A machine for listening, a reminder of persistence, of time, and of the fragile systems we construct to live alongside our inner noise.\n\n",
          medium: "Motorized kinetic sculpture, acoustic rain stick, PVC pipe, screws, wood, steel, mung beans, black rice, exposed electronics",
